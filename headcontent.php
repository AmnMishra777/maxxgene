...
function headpart()
{
$heads ="<meta charset='utf-8'>
    <title>MAXXGENE</title>
...
function topbanner()
{
	$topbaner = "<div class='container-fluid bg-dark px-5 d-none d-lg-block'>
        <div class='row gx-0'>
            ...
            <div class='col-lg-4 text-center text-lg-end'>
                <div class='d-inline-flex align-items-center' style='height: 45px;'>
                    ...
                    <a class='btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2' href='https://www.facebook.com/groups/143538661040872/?ref=share_group_link'><i class='fab fa-facebook-f fw-normal'></i></a>
...
function nav($key)
{
	$menu ="<nav class='navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0'>
            <a href='index.html' class='navbar-brand p-0'>
                <h1 class='text-primary m-0'><i class='fa fa-map-marker-alt me-3'></i>MAXXGENE</h1>
...
function footer($footindex)
{
	$footerdiv =" <div class='container-fluid bg-dark text-light footer pt-5 mt-5 wow fadeIn' data-wow-delay='0.1s'>
            ...
            <div class='copyright'>
                <div class='row'>
                    <div class='col-md-6 text-center text-md-start mb-3 mb-md-0'>
                        &copy; <a class='border-bottom' href='#'>MAXXGENE</a>, All Right Reserved.

                      
                        Designed By <a class='border-bottom' href='https://onlineservicesinc.com'>VIVAAN </a>
                    </div>
